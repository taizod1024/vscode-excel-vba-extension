...
* Excelインスタンス取得時にデバッグ停止コマンドを追加 ([b16b72d](https://github.com/taizod1024/vscode-excel-vba-extension/commit/b16b72dab9336cff1f1048d016e5a2edafb35a7c))
* デバッグ停止コマンドのコメントを追加 ([0ca3eec](https://github.com/taizod1024/vscode-excel-vba-extension/commit/0ca3eec380b9fe203e82122cdf6f1b824b475d89))
...
* SnapToGrid機能を有効化するロジックを各モジュールに追加 ([ff9ea7c](https://github.com/taizod1024/vscode-excel-vba-extension/commit/ff9ea7c5c814ea796dc6bf006f035366c2beefb2))

### [0.2.5](https://github.com/taizod1024/vscode-excel-vba-extension/compare/v0.2.4...v0.2.5) (2026-02-15)


### Bug Fixes

* Snap to Grid機能を無効化し、テーブルスタイルを更新 ([e7a2060](https://github.com/taizod1024/vscode-excel-vba-extension/commit/e7a2060ffd2181db014bfe102c12e9aef9f7a458))
